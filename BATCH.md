...
## 2026-09-18 — Documentation conflicts
...
Scope: Documentation conflicts; six European competitions. No product selection,
vendor contact, subscription purchase or Gate 1 approval.
Evidence and results: research/documentation-conflicts/. Status: research in progress.

Completed public research pass on 2026-09-18. Results, source IDs and open
dependencies are in research/documentation-conflicts/report.md and handoff.md.
Verification: research/documentation-conflicts/verification.md. Original study unchanged.
