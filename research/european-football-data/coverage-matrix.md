...
|------------------|----------------|---------------------------|--------------:|------------------------------------------------------------------------------|-----------------------------------|
| Premier League   | 2015/16        | `data/matches/2/27.json`  |           380 | ChatGPT inspected/count reported in [coverage-statsbomb-open-data-sample.md](source-reports/coverage-statsbomb-open-data-sample.md) | Codex independently checked count |
...
- Sportmonks quota mapping is 2,000 / 2,500 / 3,000 / 5,000 per
  entity/hour; [rights-sportmonks.md](source-reports/rights-sportmonks.md) corrects the continuation's
...
Codex edited this working edition to correct reviewer attribution and avoid treating candidate status as established legitimacy. The [original deliverable](original-deliverables/coverage-matrix.md) is preserved unchanged. See the [publication notes](publication-notes.md) and [source manifest](import-manifest.json).
